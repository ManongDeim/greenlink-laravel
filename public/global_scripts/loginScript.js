...
async function loadUserProfile() {
  ...
  <button id="userMenuBtn" 
          class="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-full shadow-sm hover:bg-gray-50 focus:outline-none transition-all duration-200">
  ...
  <!-- Dropdown Menu -->
  <div id="userDropdown" 
       class="hidden absolute right-0 w-48 bg-white border border-gray-200 rounded-b-xl shadow-lg overflow-hidden origin-top scale-95 opacity-0 transition-all duration-200">
